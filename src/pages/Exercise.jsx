...
const Exercise = () => {
  ...
  const fetchData = async (id) => {
      const options = {
        ...
        headers: {
          'X-RapidAPI-Key': '6cf5c57b07mshf026b83154c25c0p1a7d93jsn8a9d17accc1c',
        ...
        {relatedVideos && relatedVideos.length > 0 && (
          ...
          <div className="related-videos">
            {relatedVideos.map((video, index) => { return index < 15 && (
              <div className="related-video" key={index} onClick={()=> window.open(`https://youtube138.p.rapidapi.com/auto-complete/?q=desp&hl=en&gl=US`, "_blank")} >
